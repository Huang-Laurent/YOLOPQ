...
_C.DATASET.DATAROOT = '/content/bdd100k/images/100k'       # the path of images folder
_C.DATASET.LABELROOT = '/content/data2/zwt/bdd/bdd100k/labels/100k'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/content/bdd_seg_gt'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/content/bdd_lane_gt'               # the path of ll_seg_annotations folder
...
_C.TEST.BATCH_SIZE_PER_GPU = 16 #24
_C.TEST.MODEL_FILE = ''
